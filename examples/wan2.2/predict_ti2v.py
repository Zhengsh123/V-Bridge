...
# model path
model_name          = "/pfs/zhengshenghe/f-train/VideoX-Fun/Restoration/train_output/VideoXFun-Restoration/wan22-ti2v-all-data-480p-crop/checkpoint-8200" #"/pfs/zhengshenghe/f-train/VideoX-Fun/Restoration/train_output/VideoXFun-Restoration/wan22-ti2v-all-data-480p-crop/checkpoint-1600"
...
validation_image_start = "/pfs/zhengshenghe/f-train/data/test/restoration/LQ/10Rain/0803.png"
# prompts
prompt              = (
...
with torch.no_grad():
    ...
    if validation_image_start is not None:
        input_video, input_video_mask, clip_image = get_image_to_video_latent(validation_image_start, None, video_length=video_length, sample_size=sample_size,crop_wo_resize=crop_wo_resize)
    else:
