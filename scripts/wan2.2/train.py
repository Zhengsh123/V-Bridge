...
def parse_args():
    ...
    parser.add_argument(
        "--enable_only_crop", action="store_true", help="Whether enable use centor crop to keep video size."
    )
    parser.add_argument(
        "--enable_video_resize", action="store_true", help="Whether enable video resize."
    )
    
    parser.add_argument(
        "--video_crop_size", type=int,nargs=2, default=[480, 832], help="Center crop size for video."
    )
...
def main():
    ...
    train_dataset = ImageVideoDataset(
        ...
        enable_bucket=args.enable_bucket, enable_inpaint=True if args.train_mode != "normal" else False, enable_only_crop=args.enable_only_crop, video_crop_size=args.video_crop_size,
        enable_video_resize=args.enable_video_resize
    )
